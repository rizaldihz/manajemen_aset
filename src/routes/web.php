...
Route::get('daftar-aset', 'App\Http\Controllers\AssetController@asset_view')->middleware('loggedIn','isAdmin');
Route::post('jenis-asset/create', 'App\Http\Controllers\AssetController@jenis_asset_create')->middleware('loggedIn','isAdmin');
Route::post('asset/create', 'App\Http\Controllers\AssetController@asset_create')->middleware('loggedIn','isAdmin');
...
Route::post('asset/delete', 'App\Http\Controllers\AssetController@asset_delete')->middleware('loggedIn','isAdmin');
...
Route::get('peminjaman', 'App\Http\Controllers\PeminjamanController@peminjaman_view')->middleware('loggedIn','isAdmin');
Route::get('user', 'App\Http\Controllers\UserController@user_manajemen_view')->middleware('loggedIn','isAdmin');
Route::get('user/populate-user', 'App\Http\Controllers\UserController@user_populate')->middleware('loggedIn','isAdmin');
Route::post('user/import', 'App\Http\Controllers\UserController@user_import')->middleware('loggedIn','isAdmin');
Route::get('user/import', 'App\Http\Controllers\UserController@user_import');
Route::post('user/tambah', 'App\Http\Controllers\UserController@user_create')->middleware('loggedIn','isAdmin');
Route::post('user/tambah', 'App\Http\Controllers\UserController@user_create')->middleware('loggedIn','isAdmin');
...
Route::get('data-aset', 'App\Http\Controllers\AssetController@all_asset_view')->middleware('loggedIn','isAdmin');
Route::get('daftar-peminjaman', 'App\Http\Controllers\PeminjamanController@peminjaman_getAll')->middleware('loggedIn','isAdmin');
Route::get('export-excel', 'App\Http\Controllers\ReportController@export_excel')->middleware('loggedIn','isAdmin');
...
Route::get('report', 'App\Http\Controllers\ReportController@report_view')->middleware('loggedIn','isAdmin');
